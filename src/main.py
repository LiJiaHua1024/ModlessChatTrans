...
def start_translation(config):
    ...
    from modless_chat_trans.context_buffer import ContextBuffer
    ...
    def callback(line, arrival_time, slot_id=None, data_type="webui", rage_mode=False):
        """
        翻译单条待发送消息（剪贴板 / WebUI 输入）。
